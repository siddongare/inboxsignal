              ...
              return (
                <div key={`${line}-${i}`} id={`subject-${i}`} style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                    ...
                    {isFirst && (
                      <span className="subject-primary-badge" style={{ fontFamily: "'Geist Mono', 'DM Mono', monospace", padding: "2px 8px", borderRadius: 999, background: "rgba(99,102,241,0.15)", color: "#818CF8", border: "1px solid rgba(99,102,241,0.28)", letterSpacing: "0.05em", whiteSpace: "nowrap" }}>
                        ★ Primary
                      </span>
                    )}
                  </div>
